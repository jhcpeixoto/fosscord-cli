...
const cdnUrl = "https://github.com/fosscord/fosscord-cdn";
...
function stop() {
  ...
  console.log("Stopping cdn...");
  pm2.stop("fosscord-cdn", (err, proc) => {
    if (err) throw err;
  });
}
...
function update() {
  ...
  exec(
    "cd api && git pull && npm i && cd ../gateway && git pull && npm i && cd ../cdn && git pull && npm i"
  );
}
